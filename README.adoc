...
I’ve chosen https://kubernetes.io/docs/setup/minikube/[Minikube] which runs a single-node Kubernetes cluster inside a VM on your development machine.
...
----
_URL to open Kiali: https://localhost:<KIALI_PORT>
